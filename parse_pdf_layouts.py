...
model = lp.Detectron2LayoutModel(
    config_path = "../../koren/layout-model-training/outputs/compass2/fast_rcnn_R_50_FPN_3x/config.yaml",
    model_path = "../../koren/layout-model-training/outputs/compass2/fast_rcnn_R_50_FPN_3x/model_final.pth",
